        ...
        <nav class="navbar navbar-default navbar-static-top">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="app-navbar-collapse">
                    ...
                    <li><a href="cliente.php" role="button" aria-expanded="false"><i class="fa fa-arrow-left" aria-hidden="true"></i> retroceder</a></li>
                            <li class="dropdown">
            ...
            <div class="col-md-3 col-md-offset-0">
                ...
                <div class="col-md-6 col-md-offset-0">
                    <div class="panel panel-default">
                        <div class="panel-heading"><h2 style="text-align: center;">Agregar un nuevo cliente</h2></div>

                        <div class="panel-body">
                        <div class="col-md-12">
                           <form role="form" action="controllers/validar_cliente.php" method="POST">
