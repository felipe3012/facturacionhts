            ...
            <div class="col-md-3 col-md-offset-0">
                ...
                <div class="col-md-6 col-md-offset-0">
                    <div class="panel panel-default">
                        <div class="panel-heading"><h2 style="text-align: center;">Agregar un nuevo Proveedor</h2></div>

                        <div class="panel-body">
                        <div class="col-md-12">
                           <form role="form" action="controllers/validar_proveedor.php" method="POST">
